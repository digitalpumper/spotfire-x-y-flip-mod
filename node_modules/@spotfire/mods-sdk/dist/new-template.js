...
import { ModType, capitalize, capitalizeBeforeSeparators, getDirname, getVersion, mkStdout, } from "./utils.js";
export async function createTemplate(modType, { outDir, ...quiet }) {
    ...
    try {
        ...
        const templatesFolder = path.resolve(dirname, "..", "templates", modType === ModType.Action ? "actions" : "visualizations");
        ...
        if (files.length > 0) {
            ...
            while (answer !== "yes" && answer !== "no") {
                answer = await rl.question("The target folder is not empty. Are you sure you want to continue? [yes/no]\n");
            }
            if (answer === "no") {
                return;
            }
        ...
        fse.writeFile(packageJsonpath, packageJson.replace("MODS-SDK-VERSION", version), { encoding: "utf-8" });
