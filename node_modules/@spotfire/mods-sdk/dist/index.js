...
(async () => {
    ...
    program
        .command("new")
        .argument("<mod-type>", "the type of Mod you want to create, action or visualization", (arg) => assertModType(arg))
    ...
    function assertModType(arg) {
        if (arg === "action") {
            ...
            program.error(`Invalid mod type '${arg}'. Possible values are: action or visualization.`);
        }
    }
})();
